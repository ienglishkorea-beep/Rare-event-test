...
def base_structure_filters_pass(full_df: pd.DataFrame, start_idx: int, box_len: int, pivot_price: float, box_low: float) -> bool:
    """
    네가 원하는 구조:
    하락/조정 -> 바닥 -> 반등 -> 상단 압축
    상승 추세 중간의 횡보는 제거
